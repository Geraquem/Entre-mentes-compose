...
fun InstrOnlineRanking() {
    ...
    CompositionLocalProvider(
        ...
        Column(
            ...
            InstructionsText(R.string.instr_online_ranking_1)

            SpacerLarge()

            PhaseSeparator(R.string.instr_online_ranking_2)

            SpacerMedium()

            InstructionsText(R.string.instr_online_ranking_3)

            SpacerSmall()

            InstructionsText(R.string.instr_online_ranking_4)
            ...
            InstructionsText(R.string.instr_online_ranking_5)

            SpacerSmall()

            InstructionsText(R.string.instr_online_ranking_6)

            SpacerLarge()

            PhaseSeparator(R.string.instr_online_ranking_7)

            SpacerMedium()

            InstructionsText(R.string.instr_online_ranking_8)

            SpacerSmall()

            InstructionsText(R.string.instr_online_ranking_9)

            SpacerSmall()

            InstructionsText(R.string.instr_online_ranking_10)
            ...
            InstructionsText(R.string.instr_online_ranking_11)

            SpacerSmall()

            InstructionsText(R.string.instr_online_ranking_12)

            SpacerSmall()

            InstructionsText(R.string.instr_online_ranking_13)
